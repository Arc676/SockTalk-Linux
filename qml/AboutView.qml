...
Page {
	...
	ScrollView {
		...
		Column {
			...
			WrappingLabel {
				text: "SockTalk Client - " +i18n.tr("written by Arc676/Alessandro Vinciguerra. Project available under") + " GPLv3. Copyright 2019 Arc676/Alessandro Vinciguerra <alesvinciguerra@gmail.com>"
			}
			...
			WrappingLabel {
				text: i18n.tr("For the full license text, visit the <a href='https://github.com/Arc676/SockTalk-Linux'>repository</a> or the <a href='http://www.gnu.org/licenses/'>GNU licenses page</a>")
			}
		}
	}
}
